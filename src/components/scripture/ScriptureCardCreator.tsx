...
const ASPECT_RATIOS = [
  { id: 'square', name: '正方形', ratio: 'aspect-square' },
  { id: 'portrait', name: '直式 3:4', ratio: 'aspect-[3/4]' },
  { id: 'story', name: '限動 9:16', ratio: 'aspect-[9/16]' },
  { id: 'landscape', name: '橫式 4:3', ratio: 'aspect-[4/3]' },
];
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <div
              ref={cardRef}
              className={`relative ${aspectRatio.ratio} w-full max-w-sm mx-auto rounded-lg overflow-hidden`}
              style={{
            ...
            >
              ...
              <div className={`relative h-full flex flex-col ${textPosition.align} p-5`}>
                <div className={`${textPosition.textAlign} max-w-full`}>
                  <p className={`${fontSize.verse} text-white font-medium leading-relaxed mb-2 drop-shadow-lg`}>
                    {verse.text}
                  </p>
                  ...
                  {personalMessage && (
                    <p className={`${fontSize.message} text-white/80 mt-3 italic drop-shadow`}>
                      {personalMessage}
                    </p>
                  )}
                </div>
          ...
          <div className="space-y-3">
            <div>
              <label className="text-xs font-medium mb-1.5 block">背景樣式</label>
              <div className="flex flex-wrap gap-1.5">
                ...
                <button
                  className={`px-2 h-8 rounded-lg border-2 flex items-center gap-1 bg-muted text-xs ${
            ...
            <div>
              <label className="text-xs font-medium mb-1.5 block">比例</label>
            ...
            <div>
              <label className="text-xs font-medium mb-1.5 block">文字大小</label>
            ...
            <div>
              <label className="text-xs font-medium mb-1.5 block">文字位置</label>
            ...
            <div>
              <label className="text-xs font-medium mb-1.5 block">個人感言（選填）</label>
              <Input
                placeholder="寫下你的感言..."
            ...
            <div className="flex gap-2 pt-2">
              <Button onClick={handleDownloadCard} className="flex-1 h-9" data-testid="button-download-card">
                <Download className="w-4 h-4 mr-1" />
                下載
              </Button>
              <Button onClick={handleShareCard} variant="outline" className="flex-1 h-9" data-testid="button-share-card">
