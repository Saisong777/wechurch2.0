    ...
    <div className="min-h-screen bg-background pb-8 [overflow-wrap:anywhere]">
      ...
      <main className="mx-auto max-w-6xl space-y-4 px-4 py-5 sm:px-6">
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-5">
          ...
          <label className="col-span-2 space-y-1 text-sm lg:col-span-2">搜尋<Input value={search} onChange={e => { setSearch(e.target.value); setSelected([]); }} placeholder="課表、經文或標題" /></label>
        </div>
