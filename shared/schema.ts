...
export const submissions = pgTable("submissions", {
  ...
  theme: text("theme"),
  movingVerse: text("moving_verse"),
  factsDiscovered: text("facts_discovered"),
  traditionalExegesis: text("traditional_exegesis"),
  inspirationFromGod: text("inspiration_from_god"),
  applicationInLife: text("application_in_life"),
  others: text("others"),
