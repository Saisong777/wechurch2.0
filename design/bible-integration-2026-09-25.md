...
2026-09-26 新增免費易讀聖經（簡體・新約、CC BY-SA 4.0）；和合本預設不變。
B 部署 `cc831c94-08ea-4e6c-b152-c335d711a2f4`，25 組 API 與新版只讀資料核對通過。
Sai 已回報 v2 的 iPhone 15 Pro／Chrome 四項實機測試正常；新版尺寸驗收另記。
完整來源、備份進度及證據以 [新譯本與備份驗收](bible-feb-backup-2026-09-26.md) 為準。
A 未發布，會員資料未寫入。

## 和合本基準（新增 FEB 之前）

2026-09-26 已增補 eBible.org 的新標點和合本（繁體），設為首次進入預設譯本，
並提供當代／WEB 對照選擇。B 部署 `d21c8707-81a1-4dfd-95d4-1b5e215fa1ad` 已驗收，
指紋 `1d580cca251911c0cfb2fc93429b651af4821148d5cf47b942fb264dfca33663`。
20 組線上 API、28 個資料檔校驗與 320／390／1280px 操作通過。
詳見 [和合本增補與驗收](bible-cuv-2026-09-26.md)。A 與會員資料未修改。
