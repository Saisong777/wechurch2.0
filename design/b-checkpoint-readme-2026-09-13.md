...
- B 部署：`74d531a1-6abb-49e5-9632-b21c80baca97`
- 程式指紋：`c7e3c8fdfeb70713738ffe180ac9c842d7f5affc03ccfd224e940d3a7e55affa`
- `release-manifest.json` 列出實際 B 部署的 435 個檔案與 SHA-256。
