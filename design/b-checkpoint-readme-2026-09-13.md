...
- B 部署：`c4349339-c0f7-45af-ab19-6c853fc2c3ac`
- 程式指紋：`af365247ca206fdace53ffecaa20508895b234f51457999ce9cc34d1b10cbe58`
- `release-manifest.json` 列出實際 B 部署的 449 個檔案與 SHA-256。
